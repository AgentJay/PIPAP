...
(function ($) {
  ...
  Drupal.openlayers.addBehavior('openlayers_behavior_wmsgetfeatureinfo', function (data, options) {
    ...
    if (data.map.behaviors['openlayers_behavior_wmsgetfeatureinfo']) {
	  ...
	  Drupal.openlayers.openlayers_behavior_wmsgetfeatureinfo.getfeatureinfo_usecolorbox = 
        options.getfeatureinfo_usecolorbox;
  ...
  Drupal.openlayers.openlayers_behavior_wmsgetfeatureinfo.beforegetfeatureinfo = function(layernames) {
    if((typeof $.colorbox == 'function') && ($("#popup").length == 0) && (Drupal.openlayers.openlayers_behavior_wmsgetfeatureinfo.getfeatureinfo_usecolorbox == true)) {
      $.colorbox({
        Title: "Results.",
        height: "80%",
        width: "80%",
  ...
  Drupal.openlayers.openlayers_behavior_wmsgetfeatureinfo.fillHTML = function(result) {
	...
	jQuery('#country span').trigger('click');
