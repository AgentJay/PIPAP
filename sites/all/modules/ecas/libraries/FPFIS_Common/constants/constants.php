...
*/
if ( !defined('FPFIS_COMMON_LIBRARIES_PATH') ) define('FPFIS_COMMON_LIBRARIES_PATH', realpath(dirname(__FILE__) . 'sites/all/modules/ecas/libraries'));

/*
ECAS conf
*/
if ( !defined('FPFIS_ECAS_PATH') ) define('FPFIS_ECAS_PATH', realpath(dirname(__FILE__) . 'sites/all/modules/ecas/libraries/phpcas/CAS.php'));
...
if ( !defined('FPFIS_LDAP_USER_DN') ) define('FPFIS_LDAP_USER_DN', 'uid=j53b039,ou=People,o=cec.eu.int');
if ( !defined('FPFIS_LDAP_PASSWORD') ) define('FPFIS_LDAP_PASSWORD', 'BpDDOE5Zk');
